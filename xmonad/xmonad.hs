...
myBorderWidth         = 3
myNormalBorderColor   = "#0C090A"
myFocusedBorderColor  = "#003153"
...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
    [ 
        ...
        -- Launch app launcher
        ((super, xK_a),         spawn "rofi -show drun"),
        ...
        ((0,    xF86XK_AudioRaiseVolume),
                spawn "pamixer --increase 1"),

        ((0,    xF86XK_AudioLowerVolume),
                spawn "pamixer --decrease 1"),
